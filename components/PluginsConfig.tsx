    ...
    >
      <div
        style={embedded
          ...
          : { ...modalFullScreenSize(isMobile, 16), height: isMobile ? modalFullScreenSize(isMobile, 16).height : "76vh", background: "var(--bg)", border: "1px solid var(--border)", borderRadius: 8, display: "flex", flexDirection: "column", boxShadow: "0 8px 32px rgba(0,0,0,0.18)", overflow: "hidden" }
        }
      >
        {!embedded && (
